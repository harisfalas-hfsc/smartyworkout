          ...
          {showNewPlanCard && (
            <div className="mt-8">
              <SmartyCard
                ...
                title="Want a"
                accent="new plan?"
                description="You've used all refinements on your current plans. Create a brand new personalized workout plan for €9.99."
              >
                <Button asChild size="lg">
                  <Link to="/questionnaire">Create a new workout plan — €9.99</Link>
                </Button>
              </SmartyCard>
            </div>
          )}
