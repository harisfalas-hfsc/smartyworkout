...
export const Route = createFileRoute("/_authenticated/messages")({
  head: () => ({
    meta: [
      { title: "Messages — Smarty Workout" },
      {
        name: "description",
        content: "Talk directly with the Smarty Workout team and read their replies.",
      },
      { property: "og:title", content: "Messages — Smarty Workout" },
      {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-8 sm:py-12 lg:max-w-4xl lg:px-8 lg:py-16">
      <PageHeader
        ...
        title="Messages"
        subtitle="Write to the Smarty Workout team and read our replies right here."
      />
